...
class UniteCreatorAssets{
	...
	protected function getHtmlDir($pathDir = null, $addWrapper = false){
		...
		foreach($arrFiles as $file){
			...
			if($file == ".." && $isStartPath == true){
				if($isNoFiles == true){
					$emptyText = __("empty folder", UNITECREATOR_TEXTDOMAIN);
	...
	private function putUploadFileDialog(){
		...
		?>
			<div id="uc_dialog_upload_files" title="<?php _e("Upload Files", UNITECREATOR_TEXTDOMAIN)?>" style="display:none">
				
				<div class="uc-dialog-upload-inner">
					
					<div class="uc-assets-activepath">
					<?php _e("Upload to folder: ", UNITECREATOR_TEXTDOMAIN) ?> 
						<b>
	...
	private function putDialogCreateFolder(){
		...
		<div id="uc_dialog_create_folder" title="<?php _e("Create Folder", UNITECREATOR_TEXTDOMAIN)?>" style="display:none" class="unite-inputs">
			
			<div class="unite-dialog-top"></div>
			<div class="unite-inputs-label"><?php _e("Folder Name", UNITECREATOR_TEXTDOMAIN)?></div>
			
			<input id="uc_dialog_create_folder_name" type="text" class="unite-input-regular" value="">
			
			<?php 
				$prefix = "uc_dialog_create_folder";
				$buttonTitle = __("Create Folder", UNITECREATOR_TEXTDOMAIN);
				$loaderTitle = __("Creating Folder...", UNITECREATOR_TEXTDOMAIN);
				$successTitle = __("Folder Created", UNITECREATOR_TEXTDOMAIN);
	...
	private function putDialogCreateFile(){
		...
		<div id="uc_dialog_create_file" title="<?php _e("Create File", UNITECREATOR_TEXTDOMAIN)?>" style="display:none" class="unite-inputs">
			
			<div class="unite-dialog-top"></div>
			<div class="unite-inputs-label"><?php _e("File Name", UNITECREATOR_TEXTDOMAIN)?></div>
			
			<input id="uc_dialog_create_file_name" type="text" class="unite-input-regular" value="">
			
			<?php 
				$prefix = "uc_dialog_create_file";
				$buttonTitle = __("Create File", UNITECREATOR_TEXTDOMAIN);
				$loaderTitle = __("Creating File...", UNITECREATOR_TEXTDOMAIN);
				$successTitle = __("File Created", UNITECREATOR_TEXTDOMAIN);
				HelperHtmlUC::putDialogActions($prefix, $buttonTitle, $loaderTitle, $successTitle);
			?>			
	...
	private function putDialogRenameFile(){
		...
		<div id="uc_dialog_rename_file" title="<?php _e("Rename File / Folder", UNITECREATOR_TEXTDOMAIN)?>" style="display:none" class="unite-inputs uc-dialog-rename-file">
			<div class="unite-dialog-top"></div>
			<div class="unite-inputs-label"><?php _e("Rename this file/folder to", UNITECREATOR_TEXTDOMAIN)?>:</div>
			<input id="uc_dialog_rename_file_input" type="text" class="unite-input-regular">
	
			<?php
			$prefix = "uc_dialog_rename_file";
			$buttonTitle = __("Rename", UNITECREATOR_TEXTDOMAIN);
			$loaderTitle = __("Renaming...", UNITECREATOR_TEXTDOMAIN);
			$successTitle = __("File/Dir Renamed", UNITECREATOR_TEXTDOMAIN);
			HelperHtmlUC::putDialogActions($prefix, $buttonTitle, $loaderTitle, $successTitle);
			?>
	...
	private function putDialogEditFile(){
		?>
		<div id="uc_dialog_edit_file" title="<?php _e("Edit File", UNITECREATOR_TEXTDOMAIN)?>" style="display:none" class="unite-inputs uc-dialog-edit-file">
			
			<div class="uc-dialog-inner">
				<div id="uc_dialog_edit_file_loader" class="uc-loader-wrapper">
					<span class="loader_text"><?php _e("Loading...", UNITECREATOR_TEXTDOMAIN)?></span>
				</div>
				
				<textarea id="uc_dialog_edit_file_textarea" style="display:none"></textarea>

				<div id="uc_dialog_edit_file_loadersaving" class="unite-dialog-loader" style="display:none"><?php _e("Saving File...", UNITECREATOR_TEXTDOMAIN)?></div>
				<div id="uc_dialog_edit_file_success" class="unite-dialog-success" style="display:none"><?php _e("File Saved...", UNITECREATOR_TEXTDOMAIN)?></div>
	...
	private function putDialogMoveFiles(){
		...
		?>
		<div id="uc_dialog_move_files" title="<?php _e("Move Files", UNITECREATOR_TEXTDOMAIN)?>" style="display:none" class="unite-inputs uc-dialog-move-file">
			
			<div class="unite-dialog-top"></div>
			
			<div id="uc_dialog_move_label" class="unite-inputs-label" data-text="<?php _e("Move %1 files to", UNITECREATOR_TEXTDOMAIN)?>">:</div>
			...
			<?php 
				...
				$buttonTitle = __("Move Files", UNITECREATOR_TEXTDOMAIN);
				$loaderTitle = __("Moving Files...", UNITECREATOR_TEXTDOMAIN);
				$successTitle = __("Files Moved", UNITECREATOR_TEXTDOMAIN);
				HelperHtmlUC::putDialogActions($prefix, $buttonTitle, $loaderTitle, $successTitle);
			?>
			...
			<div id="uc_dialog_move_message" class="uc-dialog-move-message" style="display:none">
				...
				<a href="javascript:void(0)" class="unite-button-secondary" data-action="overwrite"><?php _e("Overwrite", UNITECREATOR_TEXTDOMAIN)?></a>
				<a href="javascript:void(0)" class="unite-button-secondary" data-action="skip"><?php _e("Skip", UNITECREATOR_TEXTDOMAIN)?></a>
				<a href="javascript:void(0)" class="unite-button-secondary" data-action="cancel"><?php _e("Cancel", UNITECREATOR_TEXTDOMAIN)?></a>
	...
	private function putActionsPanel(){
		?>
				<div class="uc-assets-buttons-panel">
					<a class="uc-button-upload-file uc-panel-button unite-button-secondary" data-action="upload" href="javascript:void(0)" ><?php _e("Upload", UNITECREATOR_TEXTDOMAIN)?></a>
					<a class="uc-button-select-all uc-panel-button unite-button-secondary button-disabled" data-action="select_all" href="javascript:void(0)"  data-textselect="<?php _e("Select All", UNITECREATOR_TEXTDOMAIN)?>" data-textunselect="<?php _e("Unselect All", UNITECREATOR_TEXTDOMAIN)?>" ><?php _e("Select All", UNITECREATOR_TEXTDOMAIN)?></a>
					<a class="uc-button-create-folder uc-panel-button unite-button-secondary" data-action="create_folder" href="javascript:void(0)"><?php _e("Create Folder", UNITECREATOR_TEXTDOMAIN)?></a>
					<a class="uc-button-create-file uc-panel-button unite-button-secondary" data-action="create_file" href="javascript:void(0)"><?php _e("Create File", UNITECREATOR_TEXTDOMAIN)?></a>
					
					<a class="uc-panel-button unite-button-secondary button-disabled uc-relate-multiple" data-action="delete" href="javascript:void(0)"><?php _e("Delete", UNITECREATOR_TEXTDOMAIN)?></a>
					<span class="uc-preloader-deleting loader_text mleft_5" style="display:none"><?php _e("deleting...", UNITECREATOR_TEXTDOMAIN)?></span>
										
					<a class="uc-panel-button unite-button-secondary button-disabled uc-relate-single uc-relate-file" data-action="edit" href="javascript:void(0)"><?php _e("Edit", UNITECREATOR_TEXTDOMAIN)?></a>
					
					<a class="uc-panel-button unite-button-secondary button-disabled uc-relate-single" data-action="rename" href="javascript:void(0)"><?php _e("Rename", UNITECREATOR_TEXTDOMAIN)?></a>
					
					<a class="uc-panel-button unite-button-secondary uc-relate-multiple button-disabled" data-action="move" href="javascript:void(0)"><?php _e("Move", UNITECREATOR_TEXTDOMAIN)?></a>
					
					<a class="uc-panel-button unite-button-secondary button-disabled uc-relate-special uc-relate-type-zip" data-action="unzip" href="javascript:void(0)"><?php _e("Unzip", UNITECREATOR_TEXTDOMAIN)?></a>
					<span class="uc-preloader-unzip loader_round mleft_5" style="display:none"><?php _e("unzipping...", UNITECREATOR_TEXTDOMAIN)?></span>
		...
		?>
				<div class="uc-assets-activepath">
					...
					<span class="uc-assets-activepath-inner">
						<?php _e("Active Path", UNITECREATOR_TEXTDOMAIN)?>:
			...
			?>
				<div <?php echo $id?>data-pathkey="<?php echo $this->pathKey?>" class="uc-assets-wrapper" <?php echo $wrapperStyle?> data-isbrowser="<?php echo $this->isBrowerMode?>" data-path="<?php echo $activePathData?>" data-startpath="<?php echo $startPathData?>" data-options="<?php echo $jsonOptions?>">
					...
					<div class="uc-preloader-filelist loader_text mtop_25" style="display:none">
						...
						<?php _e("Loading File list...", UNITECREATOR_TEXTDOMAIN)?>
