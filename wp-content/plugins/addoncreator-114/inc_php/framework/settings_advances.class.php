...
defined('_JEXEC') or die('Restricted access');
	...
	class UniteSettingsAdvancedUC extends UniteSettingsUC{
		...
		public function updateSelectToAlignHor($name, $default = null){
			...
			$arrItems = array(
					"left"=>__("Left",UNITECREATOR_TEXTDOMAIN),
					"center"=>__("Center", UNITECREATOR_TEXTDOMAIN),
					"right"=>__("Right", UNITECREATOR_TEXTDOMAIN)
			);
		...
		public function updateSelectToAlignVert($name, $default = null){
			...
			$arrItems = array(
					"top"=>__("Top",UNITECREATOR_TEXTDOMAIN),
					"middle"=>__("Middle", UNITECREATOR_TEXTDOMAIN),
					"bottom"=>__("Bottom", UNITECREATOR_TEXTDOMAIN)
			);
