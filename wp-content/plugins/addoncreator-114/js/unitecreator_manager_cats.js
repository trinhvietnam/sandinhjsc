function UCManagerAdminCats(){
	...
	function addCategory(){
		...
		g_manager.ajaxRequestManager("add_category","",g_uctext.adding_category,function(response){
	...
	function removeCategoryByID(catID){
		...
		if(confirm(g_uctext.do_you_sure_remove) == false)
			return(false);
		...
		g_manager.ajaxRequestManager("remove_category",data,g_uctext.removing_category,function(response){
	...
	function updateCategoryTitle(){
		...
		g_manager.ajaxRequestManager("update_category",data,g_uctext.updating_category);
	}
	...
	function exportCatItems(catID){
		var urlAjax = g_ucAdmin.getUrlAjax("export_cat_items", "catid="+catID);
	...
	function enableCatButtons(){
		...
		//items buttons:
		g_ucAdmin.enableButton("#button_add_images, #button_add_video");
	}
	...
	function disableCatButtons(){
		...
		//items buttons:
		g_ucAdmin.disableButton("#button_add_images, #button_add_video");		
	}
	...
	function onRemoveCategoryClick(){
			...
			if(!g_ucAdmin.isButtonEnabled(this))
				return(false);
