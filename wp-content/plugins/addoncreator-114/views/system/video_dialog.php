...
<div id="dialog_video" class="dialog-video" title="<?php _e("Add Media",UNITECREATOR_TEXTDOMAIN)?>" data-title="<?php _e("Add Media",UNITECREATOR_TEXTDOMAIN)?>" style="display:none">
	
	<!-- Type chooser -->
		
	<div id="video_dialog_loader" class="video-dialog-loader loader_text" style="display:none;">
		<?php _e("Loading Item Data...",UNITECREATOR_TEXTDOMAIN)?>
	</div>
	...
	<div id="video_dialog_inner">
		...
		<div id="video-dialog-wrap" class="video_left">
			...
			<div id="video_block_youtube" class="video-select-block">
				...
				<div class="video-title">
					<?php _e("Enter Youtube ID or URL",UNITECREATOR_TEXTDOMAIN)?>:
				</div>
				...
				<?php _e("example",UNITECREATOR_TEXTDOMAIN)?>:  <?php echo GlobalsUC::YOUTUBE_EXAMPLE_ID?>
				</div>
			...
			<div id="video_block_vimeo" class="video-select-block" style="display:none;" >
				...
				<div class="video-title">
					<?php _e("Enter Vimeo ID or URL",UNITECREATOR_TEXTDOMAIN)?>:
				</div>
				...
				<div class="video_example">
					<?php _e("example",UNITECREATOR_TEXTDOMAIN)?>:  <?php echo GlobalsUC::VIMEO_EXAMPLE_ID?>
				</div>
			...
			<div id="video_block_html5" class="video-select-block" style="display:none;">
					...
					<div class="video-title">				
						...
						<?php _e("Video MP4 Url", UNITECREATOR_TEXTDOMAIN)?>:
						<a id="dv_link_example_mp4" href="javascript:void(0)"  class="dv_link_change dv_put_example" data-targetid="dv_html5_url_mp4" data-example="http://vjs.zencdn.net/v/oceans.mp4"><?php _e("put example", UNITECREATOR_TEXTDOMAIN)?></a>
					...
					<div class="video-title">								
						...
						<?php _e("Video WEBM Url", UNITECREATOR_TEXTDOMAIN)?>:
						<a id="dv_link_example_webm" href="javascript:void(0)"  class="dv_link_change dv_put_example" data-targetid="dv_html5_url_webm" data-example="http://video-js.zencoder.com/oceans-clip.webm"><?php _e("put example", UNITECREATOR_TEXTDOMAIN)?></a>
					
					</div>
					<input type="text" id="dv_html5_url_webm" value="" class="input-url-long"></input>
		
					<div class="video-title">
						<?php _e("Video OGV Url", UNITECREATOR_TEXTDOMAIN)?>:
						<a id="dv_link_example_ogv" href="javascript:void(0)"  class="dv_link_change dv_put_example" data-targetid="dv_html5_url_ogv" data-example="http://video-js.zencoder.com/oceans-clip.ogv"><?php _e("put example", UNITECREATOR_TEXTDOMAIN)?></a>
					</div>
			...
			<div id="video_block_wistia" class="video-select-block">
				...
				<div class="video-title">
					<?php _e("Enter Wistia ID",UNITECREATOR_TEXTDOMAIN)?>:
				</div>
				...
				<div class="video_example">
				<?php _e("example",UNITECREATOR_TEXTDOMAIN)?>:  <?php echo GlobalsUC::WISTIA_EXAMPLE_ID?>
				</div>
			...
			<div class="video_props video_props_left mtop_20" style="display:none;">
					...
					<div class="video-title">
						<?php _e("Preview Image Url",UNITECREATOR_TEXTDOMAIN)?>:
						
						<a id="dv_link_change_image" href="javascript:void(0)"  class="dv_link_change" data-dialogtitle="<?php _e("Select new preview image", UNITECREATOR_TEXTDOMAIN)?>"><?php _e("change", UNITECREATOR_TEXTDOMAIN)?></a>
					...
					<div class="video-title mtop_20">
						<?php _e("Thumb Image Url",UNITECREATOR_TEXTDOMAIN)?>:
						
						<a id="dv_link_change_thumb" href="javascript:void(0)" class="dv_link_change" data-dialogtitle="<?php _e("Select new thumb image", UNITECREATOR_TEXTDOMAIN)?>"><?php _e("change", UNITECREATOR_TEXTDOMAIN)?></a>
					</div>
		...
		<input id="dv_button_video_add" type="button" class="unite-button-primary video_props" value="<?php _e("Add Video", UNITECREATOR_TEXTDOMAIN)?>" data-textadd="<?php _e("Add Video", UNITECREATOR_TEXTDOMAIN)?>" data-textupdate="<?php _e("Update Video", UNITECREATOR_TEXTDOMAIN)?>">		
